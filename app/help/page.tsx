...
export default function HelpPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Top Padding for Fixed Navigation */}
      <div className="pt-16">
        {/* Hero Section */}
            ...
            <div className="max-w-4xl mx-auto" id="faqs">
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">
                      Yes! Log into your dashboard to file claims, track their progress, and upload supporting
                      documents. Our team will process your claim within 48 hours.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">
                      We accept M-Pesa, bank transfers, and major credit/debit cards. M-Pesa is our recommended method
                      for instant policy activation.
                    </p>
                  </CardContent>
                </Card>
              </div>
